...
<div class="card shadow mb-4 border-bottom-primary">
	<div class="card-header bg-primary d-flex justify-content-between">
		...
		<button class="btn btn-dark btn-sm  btn-icon-split" data-toggle="modal" data-target="#modalInputPembelian"><span
					...
					<div class="form-group col-3">
							<div class="input-group input-group-sm">
								<input type="text" name="input_barang" id="input_barang"
									placeholder="Kode Barang/Nama Barang" style="z-index:1000"
									class="form-control typehead" data-provide="typehead" autofocus autocomplete="off">
					...
					<div class="row">
						...
						<div class="form-group col">
							...
							<select class="form-control form-control-sm" name="jenis_pembayaran" id="jenis_pembayaran"
								...
								<option value="Konsiniasi">Konsiniasi</option>
							</select>
						</div>
						<div class="form-group col" style="display: none;" id="jatuh_tempo">
						<label for="jatuh_tempo">Jenis Pembayaran</label>
							<div class="input-group input-group-sm">
								<input type="text" name="jatuh_tempo" placeholder="Tanggal Jatuh Tempo"
									id="tanggal_jatuh_tempo" class="form-control" autofocus autocomplete="off">
								<div class="input-group-append">
									<div class="input-group-text"><i class="fas fa-calendar"></i></div>
								</div>
							</div>
